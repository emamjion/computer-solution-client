...
const Footer = () => {
  ...
  return (
    <footer className=" bg-[#f3f3f3]">
      <div className="py-8 md:py-24 md:px-10 px-7 md:mx-[240px]">
        <div
          ...
          <div>
            <Link to="/" className="flex items-center md:gap-3 gap-1">
              ...
              <h1 className="text-2xl font-bold">
                Computer Solution<span className="text-[#a1c058]">.</span>
              </h1>
            </Link>
            <p className="md:w-[500px] text-[#7c7c7c] my-4">
              We specialize in comprehensive computer repair solutions to ensure
              your device runs seamlessly.Trust us to breathe new life into your
              system, optimizing speed and functionality.
            </p>
          </div>
          <div className="mt-6 md:mt-0">
            <h1 className="font-semibold text-lg mb-4">Navigation</h1>
            <Link className="flex items-center gap-1">
              <span className="text-lg text-[#a1c058]">
                <GoTriangleRight />
              </span>
              <h4>FAQ's</h4>
            </Link>
        ...
        >
          <p className="font-medium">
            Copyright &copy; {currentYear} Computer Solution. Powered by{" "}
            <Link className="text-[#a1c058]" to={"https://codeclubitsolutions.com/"}>
              CodeClub IT Solutions.
            </Link>
          </p>
          <div className="flex items-center gap-6 mt-6 md:mt-0">
            <span className="text-[#a1c058] text-2xl">
              <FaFacebook />
            </span>
            <span className="text-[#a1c058] text-2xl">
              <FaInstagram />
