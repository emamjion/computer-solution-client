...
const Banner = () => {
    return (
        <section className='md:flex items-center justify-between py-4 md:px-10 px-7 md:mx-[240px] gap-10'>
            <div className='md:w-1/2'>
                ...
                <div className='flex items-center gap-4'>
                    <button className='px-[24px] md:px-[32px] bg-[#A1C058] py-[16px] text-white font-medium rounded hover:scale-105 duration-300'>Get Started</button>
                    <button className='px-[24px] md:px-[32px] bg-[#f3f3f3] py-[16px] text-[#000] font-medium rounded hover:scale-105 duration-300'>Read More</button>
                </div>
            </div>
            <div className='mt-6 md:mt-0'>
                <img src={bannerImg} className='rounded hover:scale-105 duration-300' />
            </div>
        </section>
    );
};
