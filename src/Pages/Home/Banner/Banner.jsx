    ...
    return (
        <section className='md:flex items-center justify-between py-4 md:px-10 px-7 md:mx-[240px]'>
            <div className='md:w-1/2' data-aos="fade-up" data-aos-anchor-placement="top-bottom">
                ...
                <div className='flex items-center gap-4' data-aos="fade-up" data-aos-anchor-placement="center-bottom">
            ...
            <div className='mt-6 md:mt-0' data-aos="fade-up" data-aos-anchor-placement="top-bottom">
